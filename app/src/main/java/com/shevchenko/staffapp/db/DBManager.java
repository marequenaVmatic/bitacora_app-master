...
public class DBManager {
	...
	public TaskInfo getTaskInfo(int TaskId){
		...
		TaskInfo infoTask = new TaskInfo();
		Cursor cursor = db.query(TaskInfo.TABLENAME, null, TaskInfo.TASKID + "=" + TaskId, null, null, null, null);

		cursor.moveToFirst();
		while (!cursor.isAfterLast()) {
			infoTask.userid = cursor.getString(cursor.getColumnIndex("userid"));
			infoTask.taskID = cursor.getInt(cursor.getColumnIndex("taskID"));
			infoTask.date = cursor.getString(cursor.getColumnIndex("date"));
			infoTask.taskType = cursor.getString(cursor.getColumnIndex("taskType"));
			infoTask.latitude = cursor.getString(cursor.getColumnIndex("latitude"));
			infoTask.longitude = cursor.getString(cursor.getColumnIndex("longitude"));
			infoTask.RutaAbastecimiento = cursor.getString(cursor.getColumnIndex("RutaAbastecimiento"));
			infoTask.TaskBusinessKey = cursor.getString(cursor.getColumnIndex("TaskBusinessKey"));
			infoTask.Customer = cursor.getString(cursor.getColumnIndex("Customer"));
			infoTask.Adress = cursor.getString(cursor.getColumnIndex("Adress"));
			infoTask.LocationDesc = cursor.getString(cursor.getColumnIndex("LocationDesc"));
			infoTask.Model = cursor.getString(cursor.getColumnIndex("Model"));
			infoTask.epv = cursor.getString(cursor.getColumnIndex("epv"));
			infoTask.MachineType = cursor.getString(cursor.getColumnIndex("MachineType"));
			infoTask.Aux_valor1 = cursor.getString(cursor.getColumnIndex("Aux_valor1"));
			infoTask.Aux_valor2 = cursor.getString(cursor.getColumnIndex("Aux_valor2"));
			infoTask.Aux_valor3 = cursor.getString(cursor.getColumnIndex("Aux_valor3"));
			infoTask.Aux_valor4 = cursor.getString(cursor.getColumnIndex("Aux_valor4"));
			infoTask.Aux_valor5 = cursor.getString(cursor.getColumnIndex("Aux_valor5"));
			infoTask.distance = cursor.getString(cursor.getColumnIndex("distance"));
			infoTask.Aux_valor6 = cursor.getString(cursor.getColumnIndex("Aux_valor6"));
	...
	public long insertCompleteDetailCounter(CompleteDetailCounter detail) {
		...
		try {
			...
			db.delete(CompleteDetailCounter.TABLENAME, CompleteDetailCounter.TASKID + " = '" + detail.taskid + "' and " + CompleteDetailCounter.CODCOUNTER + " = '" +detail.CodCounter + "'", null);
	...
	public long insertPendingTinTask(TinTask task) {
		...
		try {
			SQLiteDatabase db = mDBHelper.getWritableDatabase();
			db.delete(TinTask.TABLENAME, TinTask.USERID + " = '" + task.userid + "' and " + TinTask.TASKID + " = " + task.taskid + " and " + TinTask.TASKTYPE + " = '" + task.tasktype + "' and " + TinTask.CUS + " = '" + task.cus + "'", null);
	...
	public long insertCompleteTinTask(CompltedTinTask task) {
		if(Integer.valueOf(task.quantity)>0) {
			ContentValues values = new ContentValues();
			...
			try {
				SQLiteDatabase db = mDBHelper.getWritableDatabase();
				db.delete(CompltedTinTask.TABLENAME, CompltedTinTask.USERID + " = '" + task.userid + "' and " + CompltedTinTask.TASKID + " = " + task.taskid + " and " + CompltedTinTask.TASKTYPE + " = '" + task.tasktype + "' and " + CompltedTinTask.CUS + " = '" + task.cus + "'", null);
	...
	public ArrayList<DetailCounter> getDetailCounter(){
		...
		Cursor cursor = db.query(DetailCounter.TABLENAME+ " as detail, "+ CompleteDetailCounter.TABLENAME + " as cDetail where detail.taskid = cDetail.taskid", new String[] {
				"detail."+DetailCounter.TASKID,
				"detail."+DetailCounter.CODCOUNTER,
				"detail."+DetailCounter.QUANTITY,
		}, null, null, null, null,  "detail.taskid DESC");
	...
	public ArrayList<Producto> getProductos_CUS(String RutaAbastecimiento, String Taskbusinesskey, String tasktype){
		SQLiteDatabase db = mDBHelper.getReadableDatabase();
		ArrayList<Producto> lstCUS = new ArrayList<Producto>();
		Cursor cursor = db.query(Producto.TABLENAME+" as product,"+Producto_RutaAbastecimento.TABLENAME+" as ruta "+
				"WHERE product.cus = ruta.cus and ruta.RUTAABASTECIMENTO =" + "'" + RutaAbastecimiento + "'" + " AND ruta.TASKBUSINESSKEY = '" + Taskbusinesskey + "' AND ruta.TASKTYPE ='" + tasktype + "'",null,null , null, null, null, null);

		cursor.moveToFirst();
		while (!cursor.isAfterLast()) {
			Producto prodcR = new Producto();
			prodcR.cus = cursor.getString(cursor.getColumnIndex("cus"));
			prodcR.nus = cursor.getString(cursor.getColumnIndex("nus"));
			lstCUS.add(prodcR);
			cursor.moveToNext();
		}
		cursor.close();
