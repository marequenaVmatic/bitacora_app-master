...
public class CompleteAbastecTinTaskActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completeabastetintask);
    ...
    private void loadProductos(){
        for (int i = 0; i < Common.getInstance().arrCompleteTinTasks.size(); i++) {
            if (Common.getInstance().arrCompleteTinTasks.get(i).taskid == nTaskID) {
                LinearLayout lnChild = new LinearLayout(CompleteAbastecTinTaskActivity.this);
                final int a = i;
                ...
                TextView txtContent = new TextView(CompleteAbastecTinTaskActivity.this);
                ...
                txtContent.setText(Common.getInstance().arrCompleteTinTasks.get(i).nus + ":");
                ...
                TextView txtQuantity = new TextView(CompleteAbastecTinTaskActivity.this);
                ...
                txtQuantity.setText(Common.getInstance().arrCompleteTinTasks.get(i).quantity);
    ...
    public void setService(String description) {
        ...
        Intent service = new Intent(CompleteAbastecTinTaskActivity.this, LogService.class);
